...
- **Generated/identity state-transition forms** — `ALTER TABLE ... ALTER COLUMN ... DROP EXPRESSION`, `SET GENERATED ALWAYS`, `SET GENERATED BY DEFAULT`, and `DROP IDENTITY` — are also processed through the normal audit path.
