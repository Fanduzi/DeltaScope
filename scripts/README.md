...
| test_query_access_ownership_docs.py | Static checks that deleted mixed-literal declarations retain both SDK semantic owners and the literal-operand ADR has one complete evidence-maintenance section |
