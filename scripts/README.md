...
| test_cli_metadata_e2e.sh | Starts Docker fixtures, seeds TiDB, runs metadata-aware CLI e2e flows including MySQL/TiDB database/schema aliases and MODIFY nullability restatement/transition checks, and provides JSON assertion helpers |
