...
This project is indexed by GitNexus as **DeltaScope** (11349 symbols, 24116 relationships, 274 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
