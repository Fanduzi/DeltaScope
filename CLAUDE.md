...
This project is indexed by GitNexus as **DeltaScope** (11351 symbols, 24122 relationships, 276 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
