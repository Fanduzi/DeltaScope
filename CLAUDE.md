...
This project is indexed by GitNexus as **DeltaScope** (11255 symbols, 23945 relationships, 274 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
