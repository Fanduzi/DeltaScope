...
This project is indexed by GitNexus as **DeltaScope** (3949 symbols, 8920 relationships, 213 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
