...
This project is indexed by GitNexus as **DeltaScope** (11344 symbols, 24145 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
