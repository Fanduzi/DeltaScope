...
This project is indexed by GitNexus as **DeltaScope** (10993 symbols, 23552 relationships, 273 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
