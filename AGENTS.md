...
This project is indexed by GitNexus as **DeltaScope** (11103 symbols, 23687 relationships, 273 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
