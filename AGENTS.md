...
This project is indexed by GitNexus as **DeltaScope** (11445 symbols, 24267 relationships, 276 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
