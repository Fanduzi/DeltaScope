...
This project is indexed by GitNexus as **DeltaScope** (11086 symbols, 23672 relationships, 273 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
