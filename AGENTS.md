...
This project is indexed by GitNexus as **DeltaScope** (11277 symbols, 23979 relationships, 274 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
