...
const (
	...
	ruleIDColumnBlobTypeForbid                               = "ddl.column.blob.forbid"
	ruleIDColumnJSONTypeForbid                               = "ddl.column.json.forbid"
	ruleIDColumnBitTypeForbid                                = "ddl.column.bit.forbid"
	ruleIDColumnTimestampTypeForbid                          = "ddl.column.timestamp.forbid"
