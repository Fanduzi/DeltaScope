...
func Register(registry *rule.Registry, cfg policy.Policy) error {
	for _, factory := range []struct {
		...
		{ruleID: ruleIDPGAlterClusterOnNotice, construct: newClusterOnNoticeRule},
		{ruleID: ruleIDPGAlterSetWithoutClusterNotice, construct: newSetWithoutClusterNoticeRule},
		{ruleID: ruleIDPGAlterDetachPartitionFinalizeNotice, construct: newDetachPartitionFinalizeNoticeRule},
		...
		{ruleID: ruleIDRenameTableNotice, construct: newRenameTableNoticeRule},
		{ruleID: ruleIDCreateIndexNotice, construct: newCreateIndexNoticeRule},
		{ruleID: ruleIDDropIndexNotice, construct: newDropIndexNoticeRule},
		{ruleID: ruleIDAlterDatabaseNotice, construct: newAlterDatabaseNoticeRule},
		{ruleID: ruleIDCreateProcedureNotice, construct: newMySQLTiDBCreateProcedureNoticeRule},
		{ruleID: ruleIDDropProcedureNotice, construct: newDropProcedureNoticeRule},
		{ruleID: ruleIDCreateUserNotice, construct: newCreateUserNoticeRule},
		{ruleID: ruleIDAlterUserNotice, construct: newAlterUserNoticeRule},
		{ruleID: ruleIDDropUserNotice, construct: newDropUserNoticeRule},
		{ruleID: ruleIDCreateRoleNotice, construct: newCreateRoleNoticeRule},
		{ruleID: ruleIDDropRoleNotice, construct: newDropRoleNoticeRule},
		{ruleID: ruleIDGrantNotice, construct: newGrantNoticeRule},
		{ruleID: ruleIDRevokeNotice, construct: newRevokeNoticeRule},
		{ruleID: ruleIDDropResourceGroupNotice, construct: newDropResourceGroupNoticeRule},
		{ruleID: ruleIDCreatePlacementPolicyNotice, construct: newCreatePlacementPolicyNoticeRule},
		{ruleID: ruleIDAlterPlacementPolicyNotice, construct: newAlterPlacementPolicyNoticeRule},
		{ruleID: ruleIDDropPlacementPolicyNotice, construct: newDropPlacementPolicyNoticeRule},
		{ruleID: ruleIDCreateSequenceNotice, construct: newCreateSequenceNoticeRule},
		{ruleID: ruleIDAlterSequenceNotice, construct: newAlterSequenceNoticeRule},
		{ruleID: ruleIDDropSequenceNotice, construct: newDropSequenceNoticeRule},
		// MySQL/TiDB alter action notice rules.
		{ruleID: ruleIDAlterAddColumnNotice, construct: newAlterAddColumnNoticeRule},
		{ruleID: ruleIDAlterAddConstraintNotice, construct: newAlterAddConstraintNoticeRule},
		{ruleID: ruleIDAlterDropColumnNotice, construct: newAlterDropColumnNoticeRule},
