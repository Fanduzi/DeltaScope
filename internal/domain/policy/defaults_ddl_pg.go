...
func ddlPgRules() map[string]RulePolicy {
	return map[string]RulePolicy{
		...
		"ddl.pg.alter.set_column_statistics.notice": {
			Enabled: true,
			Level:   rule.LevelNotice,
			Params:  map[string]any{},
		},
		"ddl.pg.alter.set_column_options.notice": {
			Enabled: true,
			Level:   rule.LevelNotice,
			Params:  map[string]any{},
		},
		"ddl.pg.alter.reset_column_options.notice": {
			Enabled: true,
			Level:   rule.LevelNotice,
			Params:  map[string]any{},
		},
		"ddl.pg.alter.set_column_storage.notice": {
			Enabled: true,
			Level:   rule.LevelNotice,
			Params:  map[string]any{},
		},
		"ddl.pg.alter.set_column_compression.notice": {
			Enabled: true,
			Level:   rule.LevelNotice,
			Params:  map[string]any{},
		},
		...
		"ddl.pg.create_transform.notice": {
			Enabled: true,
			Level:   rule.LevelNotice,
			Params:  map[string]any{},
		},
		"ddl.pg.create_access_method.notice": {
			Enabled: true,
			Level:   rule.LevelNotice,
			Params:  map[string]any{},
		},
		...
		"ddl.pg.alter.add_inherit.notice": {
			Enabled: true,
			Level:   rule.LevelNotice,
			Params:  map[string]any{},
		},
		"ddl.pg.alter.drop_inherit.notice": {
			Enabled: true,
			Level:   rule.LevelNotice,
			Params:  map[string]any{},
		},
		"ddl.pg.alter.add_of_type.notice": {
			Enabled: true,
			Level:   rule.LevelNotice,
			Params:  map[string]any{},
		},
		"ddl.pg.alter.drop_of_type.notice": {
			Enabled: true,
			Level:   rule.LevelNotice,
			Params:  map[string]any{},
		},
