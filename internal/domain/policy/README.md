...
| defaults.go | Defines the built-in rule policy, including expanded DDL batches for columns, primary-key semantics, indexes, alter restrictions, table options/object shape, and the Tier-1 DML rule set |
