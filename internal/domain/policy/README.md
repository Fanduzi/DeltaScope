...
| defaults.go | Defines the built-in rule policy, including expanded DDL batches for columns, indexes, alter restrictions, table options/object shape, and the Tier-1 DML rule set |
