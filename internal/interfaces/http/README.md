...
| query_access_e2e_mixed_literal_test.go | Docker-backed HTTP smoke for admitted and fail-closed MySQL 8.4 and TiDB 8.5 routes, plus HTTP default/offline and bounded credential-failure response/access-log no-leak coverage |
