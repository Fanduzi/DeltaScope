...
| handler_test.go | Verifies HTTP request binding, error mapping, JSON response shape, metadata-aware omission of offline existence caveats, and field-level rejection of MCP `connection_ref` |
