...
| query_access_e2e_mixed_literal_test.go | Docker-backed adapter and built-binary Query Access coverage across MySQL 5.7/8.0/8.4 and TiDB 8.5, including admitted mixed/literal shapes, offline regression, exact requirements, and marker no-leak assertions |
