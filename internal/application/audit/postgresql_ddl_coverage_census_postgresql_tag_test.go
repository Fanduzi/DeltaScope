...
var pgCorpusCovered = map[string]bool{
	...
	"CREATE INDEX partial":                       false,
	"CREATE INDEX expression":                    false,
	"CREATE INDEX INCLUDE":                       false,
	"CREATE INDEX USING gin":                     false,
	...
	"ALTER TABLE DROP CONSTRAINT":                false,
	...
	"ALTER SEQUENCE":                             false,
	"DROP SEQUENCE":                              false,
	"CREATE TYPE enum":                           false,
	"ALTER TYPE enum ADD VALUE":                  false,
	"DROP TYPE":                                  false,
	"CREATE MATERIALIZED VIEW":                   false,
	"DROP MATERIALIZED VIEW":                     false,
