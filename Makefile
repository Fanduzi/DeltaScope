...
# release-contract-gates: unified pre-release gate composing all version, surface, binary, launcher, dialect, and output format checks.
release-contract-gates: release-surface-gates release-version-surface-gates release-local-version-smoke release-dialect-hygiene-gates release-gitlab-codequality-smoke release-workflow-hygiene-gates
	npm test --prefix packages/deltascope-mcp
